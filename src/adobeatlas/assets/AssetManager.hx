...
import adobeatlas.core.Animation;
import adobeatlas.core.AnimationAtlas;
import adobeatlas.core.AnimationAtlasFactory;
import adobeatlas.textures.TextureAtlas;
import adobeatlas.utils.ArrayUtil;
import haxe.Json;
...
class AssetManager extends EventDispatcher
{
	...
	//private var _adobeatlas : adobeatlas;
...
class AssetPostProcessor
{
	...
	@:allow(adobeatlas.assets.AssetManager)
